...
if(length(idx')~=2*size(E2V,1))
    throw(MException('SHAPECOMPUTEERROR:nonManifoldMesh',...
          'The mesh contains non-manifold edges that need to be removed to create the shape struct.'));
end
E2T = reshape(idx', [2, size(E2V,1)])';
E2T(E2T > nf) = 0;
E2T = [E2T, edgeSg, -edgeSg];
