...
S2_vt = shape.io.generate_tex_coords(X2(:,ic), cols(1), cols(2), 1);
...
if nargin > 6
% Source mesh
shape.io.wobj_with_texture(S2, S2_vt, texture_im, [save_path, S2_name]);
end
S1_vt = P21*S2_vt;
% Target mesh: 
shape.io.wobj_with_texture(S1, P21*S2_vt, texture_im, [save_path,S1_name]);
