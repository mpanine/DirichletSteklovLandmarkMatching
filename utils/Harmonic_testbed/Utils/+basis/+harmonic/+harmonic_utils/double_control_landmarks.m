function double_control_landmarks(obj,event_obj,S1,S2,X1,X2,B1,B2)
%     [inisize, largesize, step, reg_weight, initype] = read_params();
        

        NumControlLandmarks = 1; % The munber of last landmarks that are considered "control" landmarks.
