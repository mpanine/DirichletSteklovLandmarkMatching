function [Wii, Wib, Aii] = boundary_poisson_split_intrinsic(W, A, boundary_indices)
...
Wii = W(interior_vertices,interior_vertices);
Wib = W(interior_vertices, boundary_indices);

% % A = sparse(diag( sum(Shape.A) ));
% 
Aii = A(interior_vertices,interior_vertices);
