function intrinsic_refinement(obj,event_obj,S1,S2,X1,X2,B1,B2)
...
%             size(Basis2)
        ...
        radii1 = 0.0001*ones(size(landmarks1(1:end-NumControlLandmarks)));
        radii2 = 0.0001*ones(size(landmarks2(1:end-NumControlLandmarks)));
        
        CentralBasis1 = computeIntrinsicBasis( 1, S1.nv, landmarks1(1:end-NumControlLandmarks), radii1 );
        CentralBasis2 = computeIntrinsicBasis( 2, S2.nv, landmarks2(1:end-NumControlLandmarks), radii2 );
        
        pF_central = annquery(CentralBasis1', CentralBasis2', 1);
        pF_central_2 = annquery( CentralBasis2', CentralBasis1', 1);
        
        
        %% Both ways optimization
...
%         [Basis1_opt, radii1] = intrinsicOptimizer(1, S1, CentralBasis2, landmarks1, landmarks2, NumControlLandmarks, radii1);
%         [Basis2_opt, radii2] = intrinsicOptimizer(2, S2, Basis1_opt, landmarks2, landmarks1, NumControlLandmarks, radii2);

%         [Basis1_opt, radii1] = intrinsicOptimizer(1, S1, Basis2, landmarks1, landmarks2, NumControlLandmarks, radii1);
%         [Basis2_opt, radii2] = intrinsicOptimizer(2, S2, Basis1_opt, landmarks2, landmarks1, NumControlLandmarks, radii2);
        
        [Basis1_opt, radii1] = intrinsicOptimizationNaive(1, S1, S2, Basis1, Basis2, landmarks1, landmarks2, NumControlLandmarks, radii1);
        [Basis2_opt, radii2] = intrinsicOptimizationNaive(2, S2, S1, Basis2, Basis1_opt, landmarks2, landmarks1, NumControlLandmarks, radii2);
        
        plot(radii1)
        hold on
        plot(radii2)
        legend('radii1 unopt', 'radii2 unopt', 'radii2 opt','radii2 opt')
...
%         [S2_opt, Basis2_opt] = refinementOptimization(S2, S1, Basis2, Basis1_opt, landmarks2, landmarks1, NumControlLandmarks);
    ...
    %% Plot some harmonic functions
        ...
        trimesh(S1.surface.TRIV, S1.surface.X, S1.surface.Y, S1.surface.Z, ...
                Basis1(:,funnumber), 'FaceColor','interp', ...
        ...
        subplot(2,3,2)
        trimesh(S1.surface.TRIV, S1.surface.X, S1.surface.Y, S1.surface.Z, ...
                CentralBasis1(:,funnumber), 'FaceColor','interp', ...
                'FaceAlpha', 1, 'EdgeColor', 'none'); axis equal;
        colorbar
        title('Intrinsic')
        ...
        subplot(2,3,3)
        trimesh(S1.surface.TRIV, S1.surface.X, S1.surface.Y, S1.surface.Z, ...
                Basis1_opt(:,funnumber), 'FaceColor','interp', ...
                'FaceAlpha', 1, 'EdgeColor', 'none'); axis equal;
        colorbar
        title('Intrinsic Opt')
        ...
        trimesh(S2.surface.TRIV, S2.surface.X, S2.surface.Y, S2.surface.Z, ...
                Basis2(:,funnumber), 'FaceColor','interp', ...
                'FaceAlpha', 1, 'EdgeColor', 'none'); axis equal;
        colorbar
        title('Harmonic')
        ...
        subplot(2,3,5)
        trimesh(S2.surface.TRIV, S2.surface.X, S2.surface.Y, S2.surface.Z, ...
                CentralBasis2(:,funnumber), 'FaceColor','interp', ...
                'FaceAlpha', 1, 'EdgeColor', 'none'); axis equal;
        colorbar
        title('Intrinsic')
        ...
        subplot(2,3,6)
        trimesh(S2.surface.TRIV, S2.surface.X, S2.surface.Y, S2.surface.Z, ...
                Basis2_opt(:,funnumber), 'FaceColor','interp', ...
                'FaceAlpha', 1, 'EdgeColor', 'none'); axis equal;
        colorbar
        title('Intrinsic Opt')
    ...
    visualize_map_lines(S2.surface, S1.surface, ...
        pF_central, ...
        euclidean_fps(S2.surface,50));    
    title(sprintf('intrinsic unoptimized'));
    ...
    visualize_map_lines(S2.surface, S1.surface, ...
        pF_opt_back, ...
        euclidean_fps(S2.surface,50));    
    title(sprintf('intrinsic optimized'));
    ...
    visualize_map_lines(S2.surface, S1.surface, ...
        pF_central, ...
        euclidean_fps(S2.surface,50),'k');    
    title(sprintf('unoptimized intrinsic'));
    ...
    visualize_map_lines(S2.surface, S1.surface, ...
        pF_opt_back, ...
        euclidean_fps(S2.surface,50),'k');    
    title(sprintf('optimized harmonic'));
