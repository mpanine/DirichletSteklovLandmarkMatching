function [Wii, Wib, Aii] = boundary_poisson_split_central(Shape, boundary_indices)
% Splits the central FE cotangent Laplacian on a mesh to interior-interior and
...
interior_vertices = 1:size(Shape.WC,1);
...
Wii = Shape.WC(interior_vertices,interior_vertices);
Wib = Shape.WC(interior_vertices, boundary_indices);
