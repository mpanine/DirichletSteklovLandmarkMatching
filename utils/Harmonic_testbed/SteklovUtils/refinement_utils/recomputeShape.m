function [S] = recomputeShape(S_in, varargin)
%THIS IS A MODIFIED SPECIALIZED VERSION OF PREPROCESS !!!!!!
%shape_index only makes sense for the dataset at hand !!!
%use shape_index = 0 for no rotation of the shapes.
