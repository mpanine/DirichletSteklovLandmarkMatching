function ND = normalDerivativeAtLandmarkBoundaryCentralSteklov(Shape_refined)
%normalDerivativeAtLandmarkBoundaryCentralSteklov: Computes the normal
%derivative of all the harmonic functions with Kronecker delta boundary
%conditions at all the boundaries. Uses the projection in the Steklov basis
%to accomplish this.
