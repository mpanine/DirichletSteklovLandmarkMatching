function iterative_opt_harmonic_interact(obj,event_obj,S1,S2,X1,X2,B1,B2)
...
%             size(Basis2)
        ...
        sigma = 0.05;
        num_iterations = 20; % How many times, after the first one, the functions on S2 are deformed.
        ...
        for iter = 1:num_iterations
            ...
            powers_iter = 0.01*ones( length(landmarks2) , 1); %
    ...
    [~, iter_opt_top_functions_2] = max(Current_Basis_2');
