function [opt_p2p_S1_to_S2, opt_p2p_S2_to_S1] = nonisometricZoomOut(S1, S2, Basis1, Basis2, p2p_S1_to_S2, p2p_S2_to_S1, start_size, end_size, step_size, landmarks1, landmarks2)
...
%     C21 = LB1(:,1:i) \ LB2(opt_p2p_S1_to_S2,1:i);
    ...
    weight = sqrt( i/size(Basis2,2) ); % Should compensate for the increase in the size of the LB basis
    
    BB1 = [weight*Basis2'; C21*(C12*C12')*LB2(:,1:i)'];
    BB2 = [weight*Basis1'; C12*(C21*C21')*LB1(:,1:i)'];

    pre_opt_p2p_S1_to_S2 = annquery(BB1, B1, 1);
    pre_opt_p2p_S2_to_S1 = annquery(BB2, B2, 1);
