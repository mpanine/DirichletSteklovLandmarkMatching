function isometricZoomOut_interact(obj,event_obj,S1,S2,X1,X2,B1,B2)
...
%         [pF_opt_2, opt_Basis1] = ICPow_optimization(opt_Basis2, Basis1, numiter, numskip);
        ...
        [pF_opt_back, pF_opt_back_2] = isometricZoomOut(S1, S2, opt_Basis1, opt_Basis2, pF_opt_2, pF_opt, 10, 30, 1, landmarks1, landmarks2);
