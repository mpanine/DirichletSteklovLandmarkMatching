function Intrinsic_ICPow_interact(obj,event_obj,S1,S2,X1,X2,B1,B2)
...
%         [S1, Basis1_opt] = refinementOptimization(S1, S2, Basis1, Basis2, landmarks1, landmarks2, NumControlLandmarks);
        ...
        [pF_opt, Basis2_power_opt] = ICPow_optimization(Basis1_opt, Basis2_opt, numiter, numskip);
        
        [pF_opt_2, Basis1_power_opt] = ICPow_optimization(Basis2_power_opt, Basis1_opt, numiter, numskip);
