% This was written after I realized that the Dirichlet-Steklov bases are
% not mutually W(M)-orthogonal

%Uses a fairly clean version of the code (at the time of writing, when no code was written)
...
Steklov_settings.num_eigs = 40+1; % Number of Steklov eigenfuncation/values PER LANDMARK. Do not set too high (20 is plenty).
...
Steklov_settings.num_LB_eigs = 40;
Steklov_settings.LB_ZO_start = 20;
Steklov_settings.LB_ZO_end = 40;
...
Src_refined = ComputeCentralSteklovAll_clean(Src, Src_landmarks, Steklov_settings);
Tar_refined = ComputeCentralSteklovAll_clean(Tar, Tar_landmarks, Steklov_settings);
...
[FmapSrcTar, p2pTarSrc, FmapTarSrc, p2pSrcTar] = CentralSteklovBoundaryMatch_clean(Src_refined,  Tar_refined, Steklov_settings);
...
[fullp2pTarSrc, fullp2pSrcTar] = CentralSteklovFindFullP2P_clean(Src_refined, Src_landmarks, Src_refined.STEKLOV.evecs, Src_refined.STEKLOV.evals,...
                                             Tar_refined, Tar_landmarks, Tar_refined.STEKLOV.evecs, Tar_refined.STEKLOV.evals,...
                                             FmapSrcTar, FmapTarSrc, Steklov_settings);
