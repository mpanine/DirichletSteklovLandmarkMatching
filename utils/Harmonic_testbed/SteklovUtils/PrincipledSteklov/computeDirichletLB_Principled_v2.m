function [Basis, evals] = computeDirichletLB_Principled_v2(Shape, boundary_indices, numEigs)
%computeDirichletLB computes the Laplace-Beltrami basis subject to
%Dirichlet boundary conditions on the boundary indices. DOES NOT REINSERT
%THE LANDMARKS.
