function [D,dD] = kernelDistance(E1, E2, sigma, power)
%KERNELDISTANCE computes the (square) gaussian kernel distance and its derivative.
...
for i = 1:length(power)
    ...
    dK22 = -2/(sigma^2) * power(i) * K22 .* ( E2d(:,i) - E2d(:,i)' ) .* ( E2der(:,i) - E2der(:,i)' );
    
    dK12 = 2/(sigma^2) * power(i) * K12 .* ( E1(:,i) - E2d(:,i)' ) .* ( zeros(size(E1(:,i))) - E2der(:,i)');
