function corr_out = reinsertBoundaryCorrespondence(p2p_S1S2, S1_landmarks, S2_landmarks, S2_Interior)
...
corr_out(non_lmks) = S2_Interior(p2p_S1S2); %takes the different orderings into account.
